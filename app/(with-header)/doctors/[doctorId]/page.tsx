...
function DoctorPage({}: DoctorPageProps) {
  ...
  const doctor = {
    ...
    posts: 250,
    fee: 699,
    languages: ["Endlish", "Hindi", "Telugu"],
  };
  ...
  return (
    <>
      ...
      <div className="grid sm:grid-cols-2 grid-cols-1 gap-4 mt-8 mb-8 mx-24">
        ...
        <div className="px-4 flex flex-col gap-10 text-white rounded">
          {/* <div className="bg-blue-500 px-4 flex flex-col gap-10 text-white rounded"> */}
          {/* A little about me */}
          <div className="flex flex-col w-full rounded-[18px] bg-white border overflow-hidden border-[#dcdcdc] ">
            {/* header */}
            ...
            <div className="flex py-8 px-7 flex-col w-full gap-7 ">
                ...
                <ul className="flex gap-2 flex-wrap">
                  {doctor.languages.map((lang) => {
                    return (
                      <button
                        key={lang}
                        className="rounded-[16px] px-[15px] py-[7px] bg-green-100 font-nunito font-medium text-[20px] leading-[20px] text-[#505050]"
                      >
                        {lang}
                      </button>
                    );
              ...
              <div className="flex items-center gap-[15px] justify-start">
                ...
                <Link
                  href="#"
                  className="flex items-center justify-center size-[40px] rounded-full bg-green-100"
                >
                  <svg
                    width="13"
                    height="22"
          ...
          <div className="flex flex-col w-full rounded-[18px] bg-white border overflow-hidden border-[#dcdcdc] ">
            ...
            {/* body */}
            <div className="flex py-8 px-7 flex-col  w-full gap-[14px] flex-wrap ">
              {/* reviews */}
              <div className="relative w-full h-[187px] rounded-[17px] overflow-hidden"></div>
